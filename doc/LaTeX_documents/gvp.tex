\ProvidesFile{gvp.tex}[v1.0.5]
\startObject{\objNameS{gvp}}{gvp}
\index{Themes!Device~interface!gvp}
\objPicture{gvpsymbol.ps}
\objItemDescription{\objNameD{gvp} is an interface to an ECHOlab DV7 video switcher,
...
\objItemComments[Figure~\objImageReference{diagram:gvpconnect1} shows how to connect a
\objNameX{gvp} object to a \objNameS{serial} object.
Figure~\objImageReference{diagram:gvpconnect2} shows how to connect a
\objNameX{gvp} object to a \objName{serialX} object.]
\objDiagram{gvpconnections1.ps}{gvpconnect1}{OS X: Connecting a \objNameX{gvp} object to a
\objNameS{serial} object}
\objDiagram{gvpconnections2.ps}{gvpconnect2}{OS 9: Connecting a \objNameX{gvp} object to a
