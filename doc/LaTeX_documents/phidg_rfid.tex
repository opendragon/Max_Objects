...
which reads RFID (\emph{R}adio \emph{F}requency \emph{ID}entification) tags.
...
\pluginItemCommands[]
  ...
  the list `\pluginCmd{\textit{standard-response}} RFIDtag' will be sent out the report output of the \objName{fidget} object.
  ...
  as the list `\pluginCmd{\textit{standard-response}} RFIDtag'.
  The value `RFIDtag' is a symbol composed from the hexadecimal representation of the RFID tag,
  prefixed with an underscore character (``\_'').
