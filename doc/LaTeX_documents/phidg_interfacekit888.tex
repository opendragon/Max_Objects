...
\pluginItemCommands[]
  ...
  The digital input is sent as the list `\pluginCmd{\textit{standard-response}} di value bit$_1$ $\ldots$ bit$_8$'.
  ...
  The analog input is sent as the list `\pluginCmd{\textit{standard-response}} ai analog$_1$ $\ldots$ analog$_8$',
  the digital input is sent as the list `\pluginCmd{\textit{standard-response}} di value bit$_1$ $\ldots$ bit$_8$' and
  the digital output is sent as the list `\pluginCmd{\textit{standard-response}} do value bit$_1$ $\ldots$ bit$_8$'.
