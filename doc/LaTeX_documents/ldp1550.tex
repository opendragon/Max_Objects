...
Player (LDP).
It sends commands to a \objNameS{serial} or a \objReference{serialX} object, which controls the serial port
...
\objItemComments[Figure~\objImageReference{diagram:ldp1550connect1} shows how to connect an
\objNameX{ldp1550} object to a \objName{serial} object.
Figure~\objImageReference{diagram:ldp1550connect2} shows how to connect an
\objNameX{ldp1550} object to a \objName{serialX} object.]
\objDiagram{ldp1550connections1.ps}{ldp1550connect1}{OS X: Connecting an \objNameX{ldp1550} object to a
\objNameS{serial} object}
\objDiagram{ldp1550connections2.ps}{ldp1550connect2}{OS 9: Connecting an \objNameX{ldp1550} object to a
\objName{serialX} object}
