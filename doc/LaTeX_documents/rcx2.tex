\ProvidesFile{rcx2.tex}[v1.0.0]
\startObject{\objNameS{rcx2}}{rcx2}
\index{Themes!Device~interface!rcx2}
\objPicture{rcx2symbol.ps}
\objItemDescription{\objNameD{rcx2} is an interface to the \companyReference{http://www.lego.com}{LEGO} MINDSTORMS RCX device.
It uses direct operations to a LEGO USB Tower.}

\objItemCreated{November 2005}
...
\objItemCompatibility{\MaxName{} 4.x \{OS X only\}}
...
\objEnd{\objNameE{rcx2}}

% $Log: rcx2.tex,v $
% Revision 1.2  2006/07/20 03:39:54  churchoflambda
% Renamed the targets for Mac OS X and Mac OS 9.
%
% Revision 1.1  2005/11/22 05:43:07  churchoflambda
