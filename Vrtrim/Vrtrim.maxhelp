...
,
		"rect" : [ 399.0, 504.0, 392.0, 318.0 ],
		"bglocked" : 0,
		"defrect" : [ 399.0, 504.0, 392.0, 318.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "prepend set",
					"fontsize" : 9.0,
					"patching_rect" : [ 11.0, 225.0, 70.0, 19.0 ],
					"id" : "obj-5",
					"numinlets" : 1,
					"fontname" : "Geneva",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "Vrtrim 1",
					"fontsize" : 9.0,
					"patching_rect" : [ 11.0, 199.0, 48.0, 19.0 ],
					"id" : "obj-6",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Removes trailing separators from a list.",
					"fontsize" : 9.0,
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 49.5, 220.0, 128.0, 220.0 ]
				}
