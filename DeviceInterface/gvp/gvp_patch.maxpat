...
,
		"rect" : [ 47.0, 174.0, 592.0, 423.0 ],
		"bglocked" : 0,
		"defrect" : [ 47.0, 174.0, 592.0, 423.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"id" : "obj-3",
					"patching_rect" : [ 265.0, 355.0, 15.0, 15.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"id" : "obj-4",
					"patching_rect" : [ 182.0, 355.0, 15.0, 15.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"id" : "obj-5",
					"patching_rect" : [ 200.0, 29.0, 15.0, 15.0 ],
					"numinlets" : 0,
					"comment" : "Commands in"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-6",
					"fontname" : "Geneva",
					"patching_rect" : [ 46.0, 350.0, 30.0, 19.0 ],
					"fontsize" : 9.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"id" : "obj-7",
					"patching_rect" : [ 210.0, 292.0, 39.0, 32.0 ],
					"numinlets" : 2,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"fontname" : "Geneva",
					"patching_rect" : [ 126.0, 221.0, 49.0, 41.0 ],
					"fontsize" : 9.0,
					"numinlets" : 2,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-11",
					"fontname" : "Geneva",
					"patching_rect" : [ 284.0, 356.0, 35.0, 19.0 ],
					"fontsize" : 9.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-16",
					"fontname" : "Geneva",
					"patching_rect" : [ 329.0, 119.0, 53.0, 17.0 ],
					"fontsize" : 9.0,
					"numinlets" : 2,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-18",
					"fontname" : "Geneva",
					"patching_rect" : [ 218.0, 31.0, 52.0, 31.0 ],
					"fontsize" : 9.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-19",
					"fontname" : "Geneva",
					"patching_rect" : [ 117.0, 348.0, 47.0, 55.0 ],
					"fontsize" : 9.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-20",
					"fontname" : "Geneva",
					"patching_rect" : [ 201.0, 348.0, 47.0, 55.0 ],
					"fontsize" : 9.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-21",
					"fontname" : "Geneva",
					"patching_rect" : [ 40.0, 33.0, 40.0, 31.0 ],
					"fontsize" : 9.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-22",
					"fontname" : "Geneva",
					"patching_rect" : [ 88.0, 31.0, 100.0, 43.0 ],
					"fontsize" : 9.0,
					"numinlets" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 1,
					"midpoints" : [ 26.0, 268.0, 219.5, 268.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 269.5, 214.0, 187.0, 214.0, 187.0, 323.0, 191.0, 323.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 269.5, 214.0, 135.5, 214.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 1,
					"midpoints" : [ 26.0, 262.0, 26.5, 262.0 ]
				}
