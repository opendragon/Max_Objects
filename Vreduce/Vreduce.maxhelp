...
,
		"rect" : [ 368.0, 343.0, 401.0, 347.0 ],
		"bglocked" : 0,
		"defrect" : [ 368.0, 343.0, 401.0, 347.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "47.25",
					"fontsize" : 9.0,
					"patching_rect" : [ 141.0, 116.0, 35.0, 17.0 ],
					"id" : "obj-1",
					"numinlets" : 2,
					"fontname" : "Geneva",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "0",
					"fontsize" : 9.0,
					"patching_rect" : [ 124.0, 98.0, 16.0, 17.0 ],
					"id" : "obj-2",
					"numinlets" : 2,
					"fontname" : "Geneva",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "Vreduce ^",
					"fontsize" : 9.0,
					"patching_rect" : [ 233.0, 196.0, 55.0, 19.0 ],
					"id" : "obj-9",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "prepend set",
					"fontsize" : 9.0,
					"patching_rect" : [ 124.0, 222.0, 74.0, 19.0 ],
					"id" : "obj-12",
					"numinlets" : 1,
					"fontname" : "Geneva",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "Vreduce min",
					"fontsize" : 9.0,
					"patching_rect" : [ 124.0, 196.0, 63.0, 19.0 ],
					"id" : "obj-13",
					"numinlets" : 1,
					"color" : [ 1.0, 0.890196, 0.090196, 1.0 ],
					"fontname" : "Geneva",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 150.5, 183.0, 242.5, 183.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 133.5, 183.0, 242.5, 183.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 150.5, 183.0, 133.5, 183.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 133.5, 183.0, 133.5, 183.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 150.5, 183.0, 23.5, 183.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-16", 0 ],
					"hidden" : 0,
					"midpoints" : [ 133.5, 183.0, 23.5, 183.0 ]
				}
